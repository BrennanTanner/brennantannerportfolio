   ...
   const PostItems = [
      {
         ...
         description: 'A large-scale social-media app focused on networking, much like linked in. The frontend made using React with MUI. The backend is built using Node.js, express, and MongoDB. Mobile view is under construction.',
         url: 'https://professional-network-frontend.vercel.app',
         github: 'https://github.com/byui-wdd430/professional-network-BrennanTanner',
         image: pronet,
      },
      {
         id: 2,
      ...
      },
      {
         id: 4,
         title: 'CRM Solutions',
         description: 'A simple static site made on commision for a small customer relations company. It is a brochure with an email function. ',
         url: '',
      ...
      },
      {
         id: 5,
         title: 'UX Case Study',
         description: 'Here is a case study presentation from a UX study done for the family search app using Figma. This UX study is only a proof of concept.',
